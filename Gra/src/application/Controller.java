...
public class Controller {
	...
	@FXML
	public void Checking(ActionEvent u) {
		
		//SudGen.puz.printSudoku();
		
		//Tutaj z powodu dziwnego i niezrozumiałego dla nas błędu wypisują się same zera zamiast liczb. Rozwiązaliśmy to tak, że sudoku wypisuje się od razu przy generacji.
	}
	@FXML
	Button check;
	@FXML
	private void StartGame(ActionEvent evt) throws IOException {
		...
		Scene buttonScene = new Scene(root,1300,200);
		check = new Button("Sprawdź wynik w terminalu/ Check the solution in terminal/Überprüfen Sie die Lösung im Terminal/ controleer de oplossing in de terminal");
